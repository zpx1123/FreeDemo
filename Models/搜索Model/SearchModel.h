...
@interface SearchModel : NSObject<QFTableViewDataSource>
{
    NSMutableArray  *_appIntroductionMutableArray;
}

@property(copy, nonatomic,readwrite) NSString*  numberViewController;//搜索app

@property(copy, nonatomic,readwrite) NSString*  searchText;//搜索app
